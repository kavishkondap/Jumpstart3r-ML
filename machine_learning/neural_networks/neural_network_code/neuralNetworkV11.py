...
model = keras.models.Sequential([
    normalizer,
    keras.layers.Reshape((num_cols, 1)),  # Add channel dimension
...
augmented_model.compile(loss=loss, optimizer=optim, metrics=metrics)
...
print("EVAL")
augmented_model.evaluate(testing_data, testing_labels, batch_size=batch_size, verbose=2)
